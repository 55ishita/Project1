...
from creator.models import  Customer
from home.models import register_table
def index(request):
...
def profilefinal(request, username):
    context={'username':username}
    return render(request, 'profile.html',context)
# def profilefinal(request,):
#     #  return HttpResponse('profilefinal')
